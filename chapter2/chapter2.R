# RNAseq course - Chapter 2
# Jesus Urtasun - December 2021
print("RNAseq course - Chapter 2")
...
mart = useMart("ENSEMBL_MART_ENS", dataset = "mmusculus_gene_ensembl", host = "may2012.arxive.ensembl.org")
# bm <- getBM(attributes = c("ensembl_gene_id", "mgi_symbol"), filters = "ensemble_gene_id", values = rownames(res_ordered), mart = mart)
# > head(bm)
